    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center">
            <ul class="navbar-nav d-none d-lg-flex">
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo site_url('StudentController/'); ?>">Dashboard</a>
                </li>
                <li class="nav-item">
...
<div class="container mt-3">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card p-4">
                <h4 class="text-center mb-4 text-success">Add New Student</h4>

                <form action="<?php echo site_url('StudentController/save'); ?>" method="POST" enctype="multipart/form-data">

                    <div class="mb-3">
                        <label for="roll_no" class="form-label">Roll Number</label>
                        <input type="number" class="form-control" id="roll_no" name="roll_no" placeholder="Enter roll number" required>
                    </div>
